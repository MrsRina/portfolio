...
// include: /tmp/tmp1t3srd5k.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/rina/Documents/personal/portfolio/portfolio.data';
      var REMOTE_PACKAGE_BASE = 'portfolio.data';
...
Module['FS_createPath']("/", "assets", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_/home/rina/Documents/personal/portfolio/portfolio.data');

      };
      Module['addRunDependency']('datafile_/home/rina/Documents/personal/portfolio/portfolio.data');
    ...
    loadPackage({"files": [{"filename": "/assets/comic-mono.ttf", "start": 0, "end": 18724}, {"filename": "/assets/cow.png", "start": 18724, "end": 49929}, {"filename": "/assets/twemoji.ttf", "start": 49929, "end": 1524225}], "remote_package_size": 1524225});

  })();

// end include: /tmp/tmp1t3srd5k.js
// include: /tmp/tmppw4f0xqn.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmppw4f0xqn.js
// include: /tmp/tmplsi4vj4x.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmplsi4vj4x.js
...
var dynCall_jiiiiiiiii = Module['dynCall_jiiiiiiiii'] = createExportWrapper('dynCall_jiiiiiiiii', 10);
